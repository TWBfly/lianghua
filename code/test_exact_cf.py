"""
Verify alignment of decoupled_5m_symbol_engines with refine_cf_3
"""
...
def run_exact_cf_test():
    ...
    print("=" * 80)
    print(f"Verified Exact Match on CF_IDX:")
    print(f"  👉 交易笔数: {len(trades)}")
    print(f"  👉 胜率 (Win Rate): {wr:.2f}% (Target: >= 51.0%)")
    print(f"  👉 盈亏比 (Profit Factor): {pf:.2f} (Target: >= 3.0)")
    print(f"  👉 单笔盈亏比 (Payoff Ratio): {payoff:.2f}")
